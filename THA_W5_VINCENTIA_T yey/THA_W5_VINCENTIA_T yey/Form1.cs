...
namespace THA_W5_VINCENTIA_T_yey
{
    public partial class Form1 : Form
    {
        ...
        private void buttonAddProduct_Click(object sender, EventArgs e)
        {
            ...
            if ((textboxNamaProduct.Text == "") && ((textboxHarga.Text == "") && ((textboxStock.Text == "") && (comboboxCategory.SelectedIndex == null))))
            {
        ...
        private void buttonRemoveCategory_Click(object sender, EventArgs e)
        {
            ...
            if (comboboxProduct.SelectedIndex != null)
            {
        ...
        private void comboboxProduct_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                if (comboboxProduct.Text == row[1].ToString())
                {
        ...
        {
            textboxNamaCategory.Text = datagridviewCategory.CurrentRow.Cells["Nama Category"].Value.ToString();
        }
    }
}
